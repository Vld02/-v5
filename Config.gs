...
const RESPONSIVE_CONFIG = Object.freeze({
  ...
  // При большей ширине масштаб интерфейса всегда равен 100%.
  compactModeWidth: 600,
  // Ширина viewport, при которой достигается минимальный масштаб интерфейса, px.
  compactMinViewportWidth: 320,
  // Минимальный допустимый масштаб интерфейса (1 = 100%).
  minimumInterfaceScale: 0.65
});
