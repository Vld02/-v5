...
const RESPONSIVE_CONFIG = Object.freeze({
  ...
  // Ниже этой ширины начинает уменьшаться масштаб интерфейса. 600 подходит для телефонов;
  // значение 10 практически никогда не включает компактный режим на реальном устройстве.
